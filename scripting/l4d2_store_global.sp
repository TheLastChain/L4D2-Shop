...
public int Weapon_Menu_Handle(Menu wmenu, MenuAction action, int client, int Position)
{
	...
	if (action == MenuAction_Select)
	{
		...
		if (StrEqual(Item, "option1"))
		{
			...
			{
				PrintToChat(client, "[SM] Your money: %i (You don't have enough money! You need 150)", g_iCredits[client]);
			}
		}
		if (StrEqual(Item, "option2"))
		{
			...
			{
				PrintToChat(client, "[SM] Your money: %i (You don't have enough money! You need 400)", g_iCredits[client]);
			}
		}
		if (StrEqual(Item, "option3"))
		{
		...
		if (StrEqual(Item, "option5"))
		{
			...
			{
				PrintToChat(client, "[SM] Your money: %i (You don't have enough money! You need 300)", g_iCredits[client]);
			}
		}
		if (StrEqual(Item, "option6"))
		{
			...
			{
				PrintToChat(client, "[SM] Your money: %i (You don't have enough money! You need 260)", g_iCredits[client]);
			}
		}
		if (StrEqual(Item, "option7"))
		{
			...
			{
				PrintToChat(client, "[SM] Your money: %i (You don't have enough money! You need 250)", g_iCredits[client]);
			}
		}
		...
		if (StrEqual(Item, "option9"))
		{
			...
			{
				PrintToChat(client, "[SM] Your money: %i (You don't have enough money! You need 500)", g_iCredits[client]);
			}
		}
		if (StrEqual(Item, "option10"))
		{
			...
			{
				PrintToChat(client, "[SM] Your money: %i (You don't have enough money! You need 510)", g_iCredits[client]);
			}
		}
		if (StrEqual(Item, "option11"))
		{
			...
			{
				PrintToChat(client, "[SM] Your money: %i (You don't have enough money! You need 1000)", g_iCredits[client]);
			}
		}
...
public int Other_Menu_Handle(Menu omenu, MenuAction action, int client, int Position)
{
	...
	if (action == MenuAction_Select)
	{
		...
		if (StrEqual(Item, "option1"))
		{
			...
			{
				PrintToChat(client, "[SM] Your money: %i (You don't have enough money! You need 100)", g_iCredits[client]);
			}
		}
		if (StrEqual(Item, "option2"))
		{
			...
			{
				PrintToChat(client, "[SM] Your money: %i (You don't have enough money! You need 60)", g_iCredits[client]);
			}
		}
		if (StrEqual(Item, "option3"))
		{
			...
			{
				PrintToChat(client, "[SM] Your money: %i (You don't have enough money! You need 50)", g_iCredits[client]);
			}
		}
		if (StrEqual(Item, "option4"))
		{
			...
			{
				PrintToChat(client, "[SM] Your money: %i (You don't have enough money! You need 200)", g_iCredits[client]);
			}
		}
		if (StrEqual(Item, "option5"))
		{
			...
			{
				PrintToChat(client, "[SM] Your money: %i (You don't have enough money! You need 90)", g_iCredits[client]);
			}
		}
		if (StrEqual(Item, "option6"))
		{
			...
			{
				PrintToChat(client, "[SM] Your money: %i (You don't have enough money! You need 110)", g_iCredits[client]);
			}
		}
		if (StrEqual(Item, "option7"))
		{
			...
			{
				PrintToChat(client, "[SM] Your money: %i (You don't have enough money! You need 120)", g_iCredits[client]);
			}
		}
	}
	SetCommandFlags("give", flagszspawn | FCVAR_CHEAT);
