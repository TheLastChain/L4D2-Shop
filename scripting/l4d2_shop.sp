...
public Action HinT(int client, int args)
{
    ...
    {
        ReplyToCommand(client, "Hey, you're using Shop too fast! Please try again later.");
...
public Action GiveMoney(int client, int args)
{
	...
	if (args != 2)
	{
		PrintToChat(client, "Ah_Roon's Paradise | Usage: !givemoney <player> <money>");
	}

	g_iCredits[target] += money;
	char name[MAX_NAME_LENGTH];
	GetClientName(target, name, sizeof(name));
	PrintToChat(client, "Ah_Roon's Paradise | You gave %i to %s", money, name);
}
...
public Action Pay(int client, int args)
{
	...
	if (args != 2) ReplyToCommand(client, "Ah_Roon's Paradise | Usage: !pay <name> <money>");

	g_iCredits[target] += paymoney;
	g_iCredits[client] -= paymoney;
	PrintToChat(target, "Ah_Roon's Paradise | %s gave you %i", client, paymoney);
	PrintToChat(client, "Ah_Roon's Paradise | You gave %i to player", paymoney);
	return Plugin_Handled;
}
...
public int Weapon_Menu_Handle(Menu wmenu, MenuAction action, int client, int Position)
{
	...
	if (action == MenuAction_Select)
	{
		...
		if (StrEqual(Item, "option1"))
		{
			...
			{
				PrintToChat(client, "Ah_Roon's Paradise | Your money: %i (You don't have enough money! You need 150)", g_iCredits[client]);
			}
		}
		if (StrEqual(Item, "option2"))
		{
			...
			{
				PrintToChat(client, "Ah_Roon's Paradise | Your money: %i (You don't have enough money! You need 400)", g_iCredits[client]);
			}
		}
		if (StrEqual(Item, "option3"))
		{
		...
		if (StrEqual(Item, "option5"))
		{
			...
			{
				PrintToChat(client, "Ah_Roon's Paradise | Your money: %i (You don't have enough money! You need 300)", g_iCredits[client]);
			}
		}
		if (StrEqual(Item, "option6"))
		{
			...
			{
				PrintToChat(client, "Ah_Roon's Paradise | Your money: %i (You don't have enough money! You need 260)", g_iCredits[client]);
			}
		}
		if (StrEqual(Item, "option7"))
		{
			...
			{
				PrintToChat(client, "Ah_Roon's Paradise | Your money: %i (You don't have enough money! You need 250)", g_iCredits[client]);
			}
		}
		...
		if (StrEqual(Item, "option9"))
		{
			...
			{
				PrintToChat(client, "Ah_Roon's Paradise | Your money: %i (You don't have enough money! You need 500)", g_iCredits[client]);
			}
		}
		if (StrEqual(Item, "option10"))
		{
			...
			{
				PrintToChat(client, "Ah_Roon's Paradise | Your money: %i (You don't have enough money! You need 510)", g_iCredits[client]);
			}
		}
		if (StrEqual(Item, "option11"))
		{
			...
			{
				PrintToChat(client, "Ah_Roon's Paradise | Your money: %i (You don't have enough money! You need 1000)", g_iCredits[client]);
			}
		}
...
public int Other_Menu_Handle(Menu omenu, MenuAction action, int client, int Position)
{
	...
	if (action == MenuAction_Select)
	{
		...
		if (StrEqual(Item, "option1"))
		{
			...
			{
				PrintToChat(client, "Ah_Roon's Paradise | Your money: %i (You don't have enough money! You need 100)", g_iCredits[client]);
			}
		}
		if (StrEqual(Item, "option2"))
		{
			...
			{
				PrintToChat(client, "Ah_Roon's Paradise | Your money: %i (You don't have enough money! You need 60)", g_iCredits[client]);
			}
		}
		if (StrEqual(Item, "option3"))
		{
			...
			{
				PrintToChat(client, "Ah_Roon's Paradise | Your money: %i (You don't have enough money! You need 50)", g_iCredits[client]);
			}
		}
		if (StrEqual(Item, "option4"))
		{
			...
			{
				PrintToChat(client, "Ah_Roon's Paradise | Your money: %i (You don't have enough money! You need 200)", g_iCredits[client]);
			}
		}
		if (StrEqual(Item, "option5"))
		{
			...
			{
				PrintToChat(client, "Ah_Roon's Paradise | Your money: %i (You don't have enough money! You need 90)", g_iCredits[client]);
			}
		}
		if (StrEqual(Item, "option6"))
		{
			...
			{
				PrintToChat(client, "Ah_Roon's Paradise | Your money: %i (You don't have enough money! You need 110)", g_iCredits[client]);
			}
		}
		if (StrEqual(Item, "option7"))
		{
			...
			{
				PrintToChat(client, "Ah_Roon's Paradise | Your money: %i (You don't have enough money! You need 120)", g_iCredits[client]);
			}
		}
	}
	SetCommandFlags("give", flagszspawn | FCVAR_CHEAT);
